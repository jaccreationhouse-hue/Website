...
export default function Home() {
  ...
  return (
    <div className="page" style={{ display: 'block' }}>
          ...
          <div className="hero-content-left">
            ...
            <ScrollReveal direction="up" delay={350} eager>
              <div className="hero-cta-group">
                ...
                <div className="hero-video-trigger" onClick={() => setIsVideoModalOpen(true)}>
      ...
      <section className="section home-about-section" style={{ background: 'var(--gray-50)', borderBottom: '1px solid var(--gray-100)', padding: '48px 20px' }}>
        <div className="wrap">
          <ScrollReveal direction="up">
            <div 
              className={`brutal-about-card ${isAboutFlipped ? 'is-flipped' : ''}`}
              onClick={() => setIsAboutFlipped(!isAboutFlipped)}
            >
              <div className="brutal-card-inner">
                {/* FRONT SIDE */}
                <div className="brutal-card-front">
                  <div className="scanlines"></div>
                  <div className="noise"></div>
                  
                  <div className="about-container-card">
                    <div className="about-left-col">
                      <span className="chip" style={{ background: 'var(--orange-light)', color: 'var(--orange)', border: 'none', marginBottom: '12px' }}>Something</span>
                    ...
                    <div className="about-right-col">
                      <p>We provide premium quality IT services to our clients through the latest technologies at an affordable cost.</p>
                      <p>Our goal is to dynamically grow your business, starting from the ground up or assisting in an already operating scenario.</p>
                      
                      <div className="brutal-buy-button">
                        <span>DISCOVER OUR SPIRIT</span>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                {/* BACK SIDE */}
                <div className="brutal-card-back">
                  <div className="scanlines"></div>
                  <div className="noise"></div>
                  
                  <div className="about-container-card dark-version">
                    <div className="about-left-col">
                      <span className="chip" style={{ background: '#333', color: '#fff', border: 'none', marginBottom: '12px' }}>Friendly & Cool</span>
                      <h2 className="about-card-title text-white">About Us</h2>
                      ...
                      <div className="brutal-image-container">
                        ...
                        >
                          ...
                          <polygon
                            ...
                            strokeWidth="2"
                          ></polygon>
                          <circle cx="50" cy="50" r="15" fill="#000" stroke="#fff" strokeWidth="3"></circle>
                          <line x1="50" y1="20" x2="50" y2="80" stroke="#fff" strokeWidth="2"></line>
                          <line x1="20" y1="50" x2="80" y2="50" stroke="#fff" strokeWidth="2"></line>
                        </svg>
                      </div>
                    </div>
                    
                    <div className="about-right-col">
                      <p className="text-gray-300">We stay cool, collected, and friendly in every situation to answer your queries and provide the absolute best service.</p>
                      <p className="text-gray-300">We prioritise clean communication, modern aesthetics, robust code, and dependable client support throughout our process.</p>
                      
                      <div className="brutal-buy-button back-btn">
      ...
      {/* INDUSTRIES WE SERVE */}
      <section className="home-section-padding industries-section" style={{ background: 'var(--white)', borderBottom: '1px solid var(--card-border)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
          <ScrollReveal direction="up" delay={100}>
            <div className="home-section-heading" style={{ textAlign: 'center' }}>
          ...
          <div className="industries-grid" style={{ justifyContent: 'center' }}>
            {[
              { name: 'Agriculture', icon: <FiWind size={32} /> },
              { name: 'Bank', icon: <FiDollarSign size={32} /> },
              { name: 'Chemical', icon: <FiDroplet size={32} /> },
              { name: 'Construction', icon: <FiTool size={32} /> },
              { name: 'Education', icon: <FiBookOpen size={32} /> },
              { name: 'Health', icon: <FiHeart size={32} /> },
              { name: 'Insurance', icon: <FiShield size={32} /> },
              { name: 'Logistics', icon: <FiTruck size={32} /> },
              { name: 'Media', icon: <FiVideo size={32} /> },
              { name: 'NGOs', icon: <FiUsers size={32} /> },
              { name: 'Real Estate', icon: <FiHome size={32} /> },
              { name: 'Retail Business', icon: <FiShoppingBag size={32} /> },
              { name: 'Social Network', icon: <FiMessageSquare size={32} /> },
              { name: 'Space', icon: <FiGlobe size={32} /> },
              { name: 'Sports', icon: <FiAward size={32} /> },
              { name: 'Tourism', icon: <FiMap size={32} /> }
            ].map((ind, idx) => (
              <ScrollReveal key={ind.name} direction="up" delay={(idx % 4) * 40}>
                <div className="industry-brutal-card">
                  ...
                  <div className="industry-card-socials">
                    <Link to="/portfolio" className="industry-card-socials-btn" title="Projects" onClick={(e) => e.stopPropagation()}>
                      <FiFolder />
                    </Link>
                    <Link to="/contact" className="industry-card-socials-btn" title="Enquiry" onClick={(e) => e.stopPropagation()}>
                      <FiMail />
                    </Link>
                    <Link to="/services" className="industry-card-socials-btn" title="Services" onClick={(e) => e.stopPropagation()}>
                      <FiExternalLink />
                    </Link>
                  </div>
                </div>
      ...
      {/* OUR HIGHLIGHTS */}
      <section className="home-section-padding highlights-showcase" style={{ background: 'var(--gray-50)', borderBottom: '1px solid var(--card-border)' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', textAlign: 'center' }}>
          <ScrollReveal direction="up" delay={100}>
          ...
          <div className="highlights-clean-grid">
            {highlights.map((stat, idx) => (
              <ScrollReveal key={stat.slug} direction="up" delay={idx * 100}>
                <div className="highlight-item-clean">
                  <div className="highlight-number-clean">{stat.value}</div>
                  <div className="highlight-label-clean">{stat.title}</div>
                </div>
              </ScrollReveal>
            ))}
          </div>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <ScrollReveal direction="up" delay={100}>
            <div className="home-section-heading">
              ...
              <h2>Focused expertise, connected around your goals.</h2>
            </div>
          </ScrollReveal>
            ...
            {serviceCatalogue.map((service, idx) => (
              <ScrollReveal key={service.title} direction="up" delay={(idx % 3) * 80}>
                <div className="what-we-do-clean-card">
                  ...
                  <h3>{service.title}</h3>
                  <p className="what-we-do-clean-desc">{service.subtitle}</p>
                  <Link to={service.path} className="what-we-do-clean-btn">Learn more</Link>
                </div>
              </ScrollReveal>
            ))}
          </div>
          ...
          <div style={{ display: 'flex', justifyContent: 'center', marginTop: '48px' }}>
            <ScrollReveal direction="up" delay={100}>
              <Link to="/services" className="btn-3d btn-3d-secondary">
                <span className="button_top">View all services</span>
              </Link>
            </ScrollReveal>
          </div>
        </div>
      ...
      {/* HOW WE ARE */}
      <section className="how-we-are-section" style={{ background: 'var(--gray-50)', borderTop: '1px solid var(--card-border)', padding: '48px 20px' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <div className="how-we-are-split-layout">
                  ...
                  <g id="box-figma">
                    ...
                    <g id="cursor">
                      ...
                      <g id="Darlley Brito">
                        ...
                        <path
                          fill="white"
                          d="M501.029 364.208C500.635 364.208 500.438 364.011 500.438 363.616V356.864C500.438 356.475 500.635 356.28 501.029 356.28C501.419 356.28 501.614 356.475 501.614 356.864V357.696C501.918 357.232 502.317 356.88 502.813 356.64C503.315 356.4 503.896 356.28 504.558 356.28C504.952 356.28 505.149 356.475 505.149 356.864C505.149 357.259 505.149 357.456 504.558 357.456C503.624 357.456 502.909 357.643 502.413 358.016C501.917 358.384 501.651 358.888 501.614 359.528V363.616C501.614 364.011 501.419 364.208 501.029 364.208Z"
                        ></path>
                        <path
                          fill="white"
            ...
            <div className="how-we-are-right">
              <ScrollReveal direction="up" delay={100}>
                <h2 className="how-we-are-title" style={{ textAlign: 'center', marginBottom: '32px' }}>How we Are</h2>
              </ScrollReveal>
              
              <div className="culture-clean-grid">
                {[
                  { name: 'Like-minded Peers', icon: <FiUsers size={32} /> },
                  { name: 'Flexible Timings', icon: <FiClock size={32} /> },
                  { name: 'Relax Zone', icon: <FiCoffee size={32} /> },
                  { name: 'Casual Dress Code', icon: <FiSmile size={32} /> },
                  { name: 'High Potential for Career Growth', icon: <FiTrendingUp size={32} /> },
                  { name: 'Hyper-Growth Mode', icon: <FiZap size={32} /> }
                ].map((item, idx) => (
                  <ScrollReveal key={item.name} direction="up" delay={(idx % 3) * 60}>
                    <div className="culture-flat-item">
                      <span className="culture-flat-icon">{item.icon}</span>
                      <h3>{item.name}</h3>
                    </div>
                  </ScrollReveal>
                ))}
      ...
      <section className="home-section-padding trusted-companies-section" style={{ background: 'var(--white)', borderTop: '1px solid var(--card-border)', borderBottom: '1px solid var(--card-border)', overflow: 'hidden' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto', padding: '0 20px' }}>
          <ScrollReveal direction="up" delay={100}>
            <span className="trusted-kicker" style={{ display: 'block', textAlign: 'center', marginBottom: '8px', color: 'var(--orange)', fontWeight: '700', letterSpacing: '1.5px', textTransform: 'uppercase', fontSize: '14px' }}>Partners & Clients</span>
            <h2 className="trusted-title" style={{ fontSize: '32px', fontWeight: '800', fontFamily: "'Syne', sans-serif", color: 'var(--black)', textAlign: 'center', marginBottom: '12px', letterSpacing: '-0.5px' }}>Trusted by Great Companies</h2>
            <p className="trusted-subtitle" style={{ fontSize: '16px', color: 'var(--gray)', textAlign: 'center', maxWidth: '600px', margin: '0 auto 36px auto', fontFamily: "'Outfit', sans-serif", lineHeight: '1.5' }}>We collaborate with forward-thinking enterprises, startups, and agencies to build high-impact digital experiences.</p>
          </ScrollReveal>
        </div>
      ...
      {isVideoModalOpen && (
        <div className="video-modal-overlay" onClick={() => setIsVideoModalOpen(false)}>
          <button className="video-modal-close-btn" onClick={() => setIsVideoModalOpen(false)} aria-label="Close video">
            <FiX size={24} />
          </button>
          <div className="video-modal-container" onClick={(e) => e.stopPropagation()}>
            <div style={{ position: 'relative', paddingBottom: '56.25%', height: 0, overflow: 'hidden' }}>
              <iframe
                src="https://www.youtube.com/embed/9ZVvfyHMn1A?si=amoO4zIukc1FFrdU&autoplay=1"
